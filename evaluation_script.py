...
inputfilename = "SubtaskB_EvaluationData_labeled_CNN_batch100_FreqThreshold=5_MaxEpoch=10.csv"
filename="SubtaskB_EvaluationData_labeled.csv"
...
print(metrics.classification_report(golddictlist, inputdictlist))

from sklearn.metrics import confusion_matrix
import seaborn as sns
import matplotlib.pyplot as plt
conf_mat = confusion_matrix(golddictlist, inputdictlist)

sns.heatmap(conf_mat, annot=True, fmt='d',
            xticklabels=["nonsuggestion","suggestion"], yticklabels=["nonsuggestion","suggestion"])
plt.title('CNN Subtask A')
plt.ylabel('Actual')
